  ...
  return (
    <div className="flex flex-col md:flex-row bg-slate-900 border border-slate-800 rounded-3xl overflow-hidden shadow-2xl">
      ...
      <div className="p-8 flex-1">
        ...
        <div className="mb-6">
          <h3 className="text-indigo-400 font-bold text-xs uppercase mb-2">Cast</h3>
          <p className="text-slate-300">{data.Actors}</p>
        </div>

        <div>
          <h3 className="text-indigo-400 font-bold text-xs uppercase mb-2">Plot Summary [cite: 20]</h3>
